...
public:
	...
	void initializeForBeginPlay(const std::vector<msr::airlib::AirSimSettings::AdditionalCameraSetting>& additionalCameras);///////////////////////////////////add camera
	VehiclePawnWrapper* getVehiclePawnWrapper();

	virtual void NotifyHit(class UPrimitiveComponent* MyComp, class AActor* Other, class UPrimitiveComponent* OtherComp, bool bSelfMoved, FVector HitLocation,
		FVector HitNormal, FVector NormalImpulse, const FHitResult& Hit) override;
private: //methods
	void setupComponentReferences(const std::vector<msr::airlib::AirSimSettings::AdditionalCameraSetting>& additionalCameras);///////////////////////////////////add camera
...
private: //variables
	...
	UPROPERTY() TArray<APIPCamera*> AdditionalCameras;///////////////////////////////////add camera
